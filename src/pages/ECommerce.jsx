      ...
      <div className="flex flex-wrap lg:flex-nowrap justify-center">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className='text-2xl'>$741,890.21</p>
            </div>
          </div>
          <div className="mt-6">
            <Button
        ...
        <div className='flex m-3 flex-wrap justify-center gap-1 items-center'>
          {earningData.map((item) => (
            <div key={item.title} className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg p-4 md:w-56 pt-9 rounded-2xl'>
              <button type='button' style={{ color: item.iconColor, backgroundColor: item.iconBg }} className='text-2xl opacity-0.9 rounded-full p-4 hover:drop-shadow-xl'>
                {item.icon}
              </button>
              <p className='mt-3'>
                <span className='text-lg font-semi-bold'>{item.amount}</span>
        ...
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780">
          ...
          <div className='mt-10 flex flex-gap-10 flex-wrap justify-center'>
            <div className="border-r-1 border-color m-4 pr-10">
              ...
              <div className="">
                <p>
                  <span className='text-2xl font-semibold'>$214,770</span>
                </p>
